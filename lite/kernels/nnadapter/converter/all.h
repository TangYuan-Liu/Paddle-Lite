...
REGISTER_CONVERTER(reduce_sum,
                   ConvertReduce,
                   "huawei_ascend_npu,cambricon_mlu,huawei_kirin_npu");
REGISTER_CONVERTER(top_k, ConvertTopK, "huawei_ascend_npu,huawei_kirin_npu");
...
REGISTER_CONVERTER(transpose2,
                   ...
                   "rockchip_npu,mediatek_apu,huawei_kirin_npu,huawei_ascend_"
                   "npu,amlogic_npu,verisilicon_timvx,kunlunxin_xtcl");
REGISTER_CONVERTER(shape, ConvertShape, "huawei_ascend_npu,cambricon_mlu,huawei_kirin_npu");
...
REGISTER_CONVERTER(squeeze,
                   ...
                   "cambricon_mlu,huawei_kirin_npu");
...
REGISTER_CONVERTER(gather, ConvertGather, "huawei_ascend_npu,cambricon_mlu,huawei_kirin_npu");
